			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath }/admitpatient"><i class="fa fa-wheelchair"></i>
								<span>Patients</span></a></li>
						<li><a href="${pageContext.request.contextPath }/appointment"><i class="fa fa-calendar"></i>
						...
						<div class="table-responsive">
							<table class="table table-striped custom-table">
								...
								<% List<Appointment> appointment =(List<Appointment>) session.getAttribute("appointment"); 
										...
										%>
									<tr>
										<td>cktd/2021/APT-<%=appointment1.getId() %></td>
										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <%=appointment1.getName() %></td>
										
										<td>Dr.Vivek</td>
										<td>MBBS</td>
									    <td><%=appointment1.getDate1() %></td>
									    <% if(appointment1.getBookstatus().equals("pending")){%>
										<td><span class="custom-badge status-red"><%=appointment1.getBookstatus() %></span></td>
										<%} else{ %>
										<td><span class="custom-badge status-green"><%=appointment1.getBookstatus() %></span></td>
										<%} %>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="${pageContext.request.contextPath }/edit/<%=appointment1.getId()%>" ><i class="fa fa-pencil m-r-5"></i> Accept</a>
													<a class="dropdown-item" href="delete/<%=appointment1.getId() %>" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
